...
// Rôle : Page Escalades reçues — affiche un message "Bientôt disponible" en attendant
...
export default function EscaladesReçues() {
  return (
    <div>
      <SectionHeader title="Escalades reçues" subtitle="Consultez l'historique des escalades SAV reçues ce mois, leur répartition par canal et le statut des webhooks." />
      <Card>
