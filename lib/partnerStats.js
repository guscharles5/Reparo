...
// Rôle : transforme les lignes "conversations" en statuts et KPIs (résolution, NPS, économies, bienvenue, escalades) pour l'espace partenaire
...
export const buildKpis = (rows, coutInterventionEvitee, ouverturesLien = 0) => {
  ...
  const tauxOuvertureLien = ouverturesLien > 0
    ? Math.round((bienvenueRows.length / ouverturesLien) * 100)
    : null
